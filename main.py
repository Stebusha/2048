...
class Number(Widget):
    ...
    colors = {
        2: get_color_from_hex('#fff5ee'),
        4: get_color_from_hex('#b9e4e1'),
        8: get_color_from_hex('#2cba9d'),
        16: get_color_from_hex('#3d6aff'),
        32: get_color_from_hex('#7e05ff'),
        64: get_color_from_hex('#c7008b'),
        128: get_color_from_hex('#c70000'),
        256: get_color_from_hex('#ff5c5c'),
        512: get_color_from_hex('#f29c07'),
        1024: get_color_from_hex('#f9f048'),
        2048: get_color_from_hex('#9bf948'),
        4096: get_color_from_hex('#05a841'),
        8192: get_color_from_hex('#07ebf2')}
